        ...
        while(true){
            ...
            switch(choose1) {
                ...
                n = sc.nextInt();
                        ...
                        switch (choose) {
                            case 1:
                            nv[ps.length -1] = new giangVien();
                            nv[ps.length-1].nhapTT();
                            break;
                            case 2:
                            nv[ps.length -1] = new nhanVienVanPhong();
                            nv[ps.length-1].nhapTT();
                            break;
                            case 3: 
                            nv[ps.length -1] = new baoVe();
                            nv[ps.length-1].nhapTT();
                            break;
